...
//Novo
int Ponto::getVizinho()
{
    return vizinho;
}
//Novo
int Ponto::getUltimoPoligono(){
    return posUltimoPoligono;
}
//Novo
void Ponto::setUltimoPoligono(int ultimopoligono){
    this->posUltimoPoligono = ultimopoligono;
}
...
bool HaInterseccao(Ponto k, Ponto l, Ponto m, Ponto n)
{
    ...
    ret = intersec2d( k,  l,  m,  n, s, t); //ve se tem intersec enventualmente
    if (!ret) return false;
