...
public class App {
    public static void main(String[] args){
        ...
        gv.entra(new Vagao(375, 50.5));
        gv.entra(new Vagao(928, 75.5));
        gv.entra(new Vagao(129, 60));
        gv.entra(new Vagao(640, 80.5));
        gv.entra(new Vagao(257, 90));
        gv.entra(new Vagao(763, 55));
        ...
        do{//menu inicial
            ...
            switch(in.nextInt()){
                case 1://criar trem
                    ...
                    locomotivaAux.vinculaLocomotiva(tremAux);
                        ...
                        System.out.println("Não existem trens no pátio. Crie um trem para poder acessar o sistema de edição.");
                            ...
                            switch(in.nextInt()){
                                ...
                                case 3://tirar último elemento
                                    if(tremAux.getListaVagoes().size() != 0){
                                        ...
                                        System.out.println("Último elemento (Vagão) removido");
                                            ...
                                            if(tremAux.getListaLocomotivas().size()>1){
                ...
                case 4://desfazer trem
                    ...
                    if(patio.getTrem(idAux) == null){
                        System.out.println("O trem com o identificador inserido não existe. Tente novamente.");
                        break;
                    }

                    for(Vagao v:patio.getTrem(idAux).getListaVagoes()){
                        gv.entra(v);
                    }

                    for(Locomotiva l:patio.getTrem(idAux).getListaLocomotivas()){
                        gl.entra(l);
                    }
